"""Chunk crawled pages and compute embeddings."""
...
from databricks_docs.vector_search_manager import VectorSearchManager
...
manager = VectorSearchManager(
    local=local,
    config_path=os.path.join(args.root_path, args.config_path),
    workspace_client=workspace_client,
)
logger.info("Config: {}", manager.config.model_dump())

count = manager.embed_files(spark=spark)

logger.info("Done. {} chunks embedded and saved to Delta.", count)
